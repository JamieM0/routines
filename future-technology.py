...
def generate_future_technology(input_data):
...
def main():
    ...
    usage_msg = "Usage: python future-technology.py <input_json> [output_json]"
    ...
    tech_data = generate_future_technology(input_data)
