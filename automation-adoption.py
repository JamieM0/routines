...
def generate_automation_adoption(input_data):
...
def main():
    ...
    usage_msg = "Usage: python automation-adoption.py <input_json> [output_json]"
    ...
    adoption_phases = generate_automation_adoption(input_data)
