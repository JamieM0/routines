...
def generate_implementation_assessment(input_data):
...
def main():
    ...
    usage_msg = "Usage: python current-implementations.py <input_json> [output_json]"
    ...
    implementation_data = generate_implementation_assessment(input_data)
